# Testing: 	python3 qtl-mapping.py -in F2_control_comparison.va  -out mapping_info.txt -out2 candidate_region.txt -width 100000 -step 100000 -f_input genome.fa	-cand_interval 2000000
