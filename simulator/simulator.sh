...
# python3 programs: sim-mut.py, sim-recsel.py, sim-seq.py.
...
rec_freq_distr=${sim_recsel_array[0]} # Recombination frequency distribution. Pass it to program as a string and analyze it with python3
