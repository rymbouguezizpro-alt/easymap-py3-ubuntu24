...
# python3 graphic-output-dev.py -my_mut qtl -asnp F2_control_comparison.va -gff SL3.gff  -iva varanalyzer_output.txt -rrl 150 -pname project  -bsnp genome.fa  -cr_file candidate_region.txt  -mut_type EMS 
# python3 graphic-output-dev.py -my_mut qtl -asnp F2_control_comparison.va -gff SL3.gff  -iva varanalyzer_output.txt -rrl 150 -pname project  -bsnp genome.fa  -cr_file candidate_region.txt  -mut_type EMS


import argparse
from draw import qtl_plot, qtl_plot_points
