...
proc = subprocess.Popen("du -s ../user_projects", shell=True, stdout=subprocess.PIPE, text=True)
folder_size_output = proc.stdout.read()
...
proc = subprocess.Popen("ls ../user_projects", shell=True, stdout=subprocess.PIPE, text=True)
